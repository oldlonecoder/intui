...
public:
    ...
    template<typename T> int16_t connect_member(T *inst, book::action(T::* func)(Args...))
    {
    ...
    // object to this notifier.
    template<typename T> int16_t connect(T *inst, book::action(T::* func)(Args...))
    {
        return connect([=](Args... args)
                       {
                           return (inst->*func)(args...);
    ...
    template<typename T> int16_t Connect(T *inst, book::action(T::* func)(Args...) const)
    {
        return connect([=](Args... args)
                       {
                           return (inst->*func)(args...);
...
public:
    ...
    // object to this notifier.
    template<typename T> int16_t connect_member(T *inst, Ret(T::* func)(Parameters...))
    {
    ...
    // Convenience method to Connect a member function of an
    // object to this notifier.
    template<typename T>  int16_t connect(T *inst, Ret(T::* func)(Parameters...))
    {
        return connect([=](Parameters... Args)
                       {
                           return (inst->*func)(Args...);
