...
/**
 * @brief Ditux::Rectangleion enums values
 * @author &copy; 2008,2022,2023, Serge Lussier, lussier.serge@gmail.com ( oldlonecoder )
 */
namespace direction
{
...
{
using value = U16;
static constexpr anchor::value fixed        = 0;
static constexpr anchor::value width_fit    = 1;
static constexpr anchor::value height_fit   = 2;
static constexpr anchor::value inframe_fit  = 4;
static constexpr anchor::value onframe_fit  = 8;
//...
}
...
struct attr_db
{
    using components = std::map<wstate::Type, ui::color::pair>;
