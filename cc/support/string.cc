...
string& string::operator|(ui::color::code color)
{
    _d_ += ui::color::render(color);
    return *this;
}


string& string::operator|(ui::color::pair colors)
{
    _d_ += ui::color::render(colors);
    return *this;
}


string& string::operator|(lus::glyph::type ig)
{
    if(ig > glyph::log) return *this;
    _d_ += lus::glyph::data[ig];
    return *this;
}


string& string::operator|(lus::accent_fr::type ac)
{
    _d_ += lus::accent_fr::data[ac];
    return *this;
}


string& string::operator|(ui::cadre::index fri)
{
    _d_ += ui::cadre()[fri];
    return *this;
}
...
size_t string::words(string::word::list& a_list, bool a_keep_as_word, const char* a_sep)
{
    ...
    //out << "separators : '" << ui::color::render(ui::color::yellow) << a_sep << ui::color::render(ui::color::reset) << "'" << std::endl;
